...
$(function() {
    ...
    */
    ...
    $('#supervisor').prepend("<option value='0'>Please Select an Option</option>").val('0').trigger("chosen:updated");
    $('[name="deposit_payment_method_1"]').prepend("<option value='0'>Please Select an Option</option>").val('0').trigger("chosen:updated");
