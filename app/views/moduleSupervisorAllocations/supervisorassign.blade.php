        ...
        <div class="row"> <h3 class="m-t-none m-b">ASSIGN SUPERVISOR TO STUDENTS</h3>
            ...
            <div class="col-sm-6 b-r">
                ...
                <div class="form-group">
                    {{ Form::checkbox('student_all',0, false, ['id' => 'student_all']) }}
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped m-b-none" data-ride="datatables" id="student_datatable" >
                            ...
                            @foreach ($students as $student)
                                <tr>
                                    <td>{{ Form::checkbox('student[]',$student->id) }}&nbsp;{{ $student->forename_1.' '.$student->surname }}</td>
                                </tr>
            ...
            <div class="col-sm-6">
                ...
                <section class="panel panel-default">
                    ...
                    <div class="panel-body">
                <div class="form-group">
                    {{ Form::checkbox('suprvisor_all',0, false, ['id' => 'suprvisor_all']) }}   {{ Form::label('san', 'Supervisors List', array('class' => 'col-sm-3 control-label'));  }}
                    <div class="col-sm-9"><input type="text" id="search_text2" class="form-control input-sm no-border"
                                                 placeholder="Search Supervisor Name ..."></div></div></section>
                            ...
                            <div class="form-group">
                                <table class="table table-striped m-b-none" data-ride="datatables" id="supervisor_datatable" >
                                    ...
                                    @foreach ($supervisorsMA as $supervisor)
                                        <tr>
                                            <td>{{ Form::checkbox('supervisor[]',$supervisor->id) }}&nbsp;{{ $supervisor->name }}</td>
                                        </tr>
