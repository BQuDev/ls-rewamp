...
class StudentMarksRMBMMAA02Controller extends \BaseController {
	...
	{
        return View::make('student_marks_RMBM_MA_A_02');
	}


    public function students_for_marks_rmbm_ma_a_02(){
        //return Student::all();
        return DB::table('students')
            ->leftJoin('students_for_marks_rmbm_ma_a_02','students.san','=','students_for_marks_rmbm_ma_a_02.san')
    ...
    public function save_marks_for_RMBM_MA_A_02(){
...
/*
        ...
        $has_row = DB::table('students_for_marks_rmbm_ma_a_02')->where('san','=',$san)->get();
        if($has_row){
			
            $mark_update = DB::table('students_for_marks_rmbm_ma_a_02')
                ->where('san', $san)
                ->update(array($col => $val));
				
			$row = DB::table('students_for_marks_rmbm_ma_a_02')->where('san','=',$san)->first();
	...
	public function to_word(){
		...
		//return Input::get('export_type');
			$student_data = DB::table('students_for_marks_rmbm_ma_a_02')
			->leftJoin('application_scj','students_for_marks_rmbm_ma_a_02.san','=','application_scj.san')
			->where('students_for_marks_rmbm_ma_a_02.san','=',$san)->get(); 
		if($student_data){
