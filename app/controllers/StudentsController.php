	...
	//$students = Student::all();
        ...
        return Excel::create('Mastersheet BQu version', function($excel) {
			...
			$excel->sheet('Mastersheet BQu version', function($sheet) {
				...
				->where('san','=','hp58x8dz')
				->orWhere('san','=','nl6l69dz')
				->orWhere('san','=','mo6xp8dz')
				->orWhere('san','=','7fk439dz')
				->orWhere('san','=','adkr39dz')
				->orWhere('san','=','vo06o8dz')
				->orWhere('san','=','2fv0q8dz')
				->orWhere('san','=','hluc49dz')
				->orWhere('san','=','furg4w6z')
				->orWhere('san','=','63f7i66z')
				->orWhere('san','=','tmjza66z')
				->orWhere('san','=','tfo6c67z')
				->orWhere('san','=','kwoagh8z')
				->orWhere('san','=','keuc3a8z')
				->orWhere('san','=','iaob9a8z')
				->orWhere('san','=','sfedb66z')
				->orWhere('san','=','1vjmb96z')
				->orWhere('san','=','r030b66z')
				->orWhere('san','=','v8qab66z')
				->orWhere('san','=','tpcvz98z')
				->orWhere('san','=','1rdtrn7z')
				->orWhere('san','=','c2y6hjaz')
				->orWhere('san','=','pm7j0a8z')
				->orWhere('san','=','b7r7b66z')
				->orWhere('san','=','xspziy7z')
				->orWhere('san','=','m067my7z')
				->orWhere('san','=','myar2r8z')
				->orWhere('san','=','u6bb7h8z')
				->orWhere('san','=','jjk1b66z')
				->orWhere('san','=','5tui1q7z')
				->get();
